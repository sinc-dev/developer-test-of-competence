...
function Auth() {
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen font-family-main">
      ...
      >
        <div className="text-white p-8 max-w-md">
          ...
          <div className="flex gap-3.5 items-center mt-8">
            <img className="w-10 h-10" src={fastIcon} alt="Fast" />
          ...
          <div className="flex gap-3.5 items-center mt-6">
            <img className="w-10 h-10" src={chartIcon} alt="Chart" />
            <h3 className="font-semibold text-tertiary">
      ...
      <div className="w-full md:w-1/2 bg-tertiary flex flex-col">
        <div className="container flex flex-col h-full">
          ...
          <nav className="flex justify-start items-center gap-3 p-5 mb-8 md:mb-12">
            <img className="w-8 md:w-10 h-8 md:h-10" src={schoolIcon} alt="Logo" />
          ...
          <div className="flex flex-col items-center justify-center flex-1">
            ...
            <div className="flex items-center justify-center gap-1 mb-8 bg-[#DCE9FF] rounded-lg p-1">
              <button
                ...
                className={`cursor-pointer px-8 py-2 font-semibold rounded transition ${
                  mode === 'login' ? 'bg-white text-neutral' : 'text-neutral hover:bg-white'
                }`}
              >
                Log In
              </button>
              <button
                ...
                className={`cursor-pointer px-8 py-2 font-semibold rounded transition ${
                  mode === 'signup' ? 'bg-white text-neutral' : 'text-neutral hover:bg-white'
                }`}
              >
                Create Account
              </button>
            ...
            <div className="w-full px-4 md:px-0 items-center max-w-sm">
              ...
              {mode === 'login' && (
                <>
                  ...
                  <div className="flex flex-col gap-3 md:gap-4 bg-white p-6 md:p-8 rounded-2xl shadow-lg">

                    {/* Email */}
                    <div className="flex flex-col">
                      <label className="text-[#151717] font-semibold text-sm mb-2">Email</label>
                      <div className="flex items-center border border-[#ecedec] rounded-xl h-12.5 px-3 transition-all duration-200 focus-within:border-[#2d79f3]">
                        <EmailIcon />
                        <input
                          type="text"
                    ...
                    {/* Submit */}
                    <button className="mt-5 mb-2.5 bg-[#151717] text-white text-[15px] font-medium rounded-xl h-12.5 w-full cursor-pointer hover:bg-[#252727] transition-colors duration-200">
                      Log In
                    </button>
                ...
                <div>
                  ...
                  <div className="flex flex-col gap-3 md:gap-4 bg-white p-6 md:p-8 rounded-2xl shadow-lg">
                    ...
                    <div className="flex flex-col">
                      ...
                      <input
                        type="text"
                        className="border border-[#ecedec] rounded-xl h-12.5 px-3 outline-none focus:border-[#2d79f3] text-sm"
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <label className="text-sm text-black font-normal">
                        I agree to the{' '}
                        <span className="text-[#2d79f3] font-medium">Terms &amp; Conditions</span>
                      </label>
                    </div>
...
function SocialButtons() {
  return (
    <div className="flex gap-2.5">
      <button className="flex-1 mt-2.5 h-12.5 rounded-xl flex justify-center items-center font-medium gap-2.5 border border-[#ededef] bg-white cursor-pointer hover:border-[#2d79f3] transition-colors duration-200">
        <GoogleIcon />
        Google
      </button>
      <button className="flex-1 mt-2.5 h-12.5 rounded-xl flex justify-center items-center font-medium gap-2.5 border border-[#ededef] bg-white cursor-pointer hover:border-[#2d79f3] transition-colors duration-200">
